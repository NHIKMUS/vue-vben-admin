...
export async function authLogin(page: Page) {
  ...
  await usernameInput.pressSequentially('admin', { delay: 150 });

  await passwordInput.fill('');
  await passwordInput.pressSequentially('123456', { delay: 150 });
  ...
  // 这个时候滑块可能还没有Visible，等待一段时间再进行拖动
  ...
  console.warn('========== Captcha Drag Check ==========');
